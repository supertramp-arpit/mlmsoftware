            ...
            return (
              ...
              >
                <div className="ultra-glass rounded-3xl p-10 h-full relative overflow-hidden">
                  ...
                  {/* Floating elements */}
                  <div className="absolute top-4 right-4 w-8 h-8 border border-cyan-500/20 rounded-full animate-spin-slow"></div>
                  <div className="absolute bottom-4 left-4 w-6 h-6 bg-purple-500/20 rounded-full animate-pulse"></div>

                  <div className="relative z-10">
                    {/* Enhanced Icon */}
                    <div className={`w-24 h-24 mb-8 rounded-3xl bg-gradient-to-r ${service.gradient} flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-2xl`}>
                    ...
                    {/* Content */}
                    <h3 className="text-3xl font-bold text-white mb-3 group-hover:text-cyan-300 transition-colors duration-300 font-['Orbitron']">
                      {service.title}
                    </h3>
                    <p className="text-cyan-400 text-lg font-medium mb-6">{service.subtitle}</p>
                    ...
                    <ul className="space-y-3 mb-8">
                      {service.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-center text-gray-300 group-hover:text-white transition-colors duration-300">
                          <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${service.gradient} mr-4 group-hover:scale-125 transition-transform duration-300`}></div>
                    ...
                    <button className={`w-full py-4 rounded-2xl bg-gradient-to-r ${service.gradient} text-white font-semibold text-lg hover:shadow-2xl transition-all duration-500 relative overflow-hidden group-hover:scale-105`}>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-8">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold text-white mb-2">Global Scale</h4>
                  <p className="text-gray-400">Built to handle millions of users worldwide</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold text-white mb-2">Bank-Level Security</h4>
                  <p className="text-gray-400">Military-grade encryption and protection</p>
                </div>
              </div>
            </div>
          </div>
